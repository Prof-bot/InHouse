...
class respawnMenuDialog {
    idd = 26893;
    movingEnable = 0;
    onLoad="['onLoad'] spawn wmi_respawn_fnc_handleRespawnUI;";
    ...
    class controls { 
        ...
        class respawnMenuAddButton: respawnMenu_RscButton
        {
            ...
            w = 0.04125 * safezoneW;
            h = 0.055 * safezoneH;
            action="['respawnMenuAddAction'] spawn wmi_respawn_fnc_handleRespawnUI";
        };
        class respawnMenuRemoveButton: respawnMenu_RscButton
        {
            ...
            w = 0.04125 * safezoneW;
            h = 0.055 * safezoneH;
            action="['respawnMenuRemoveAction'] spawn wmi_respawn_fnc_handleRespawnUI";
        };
        class respawnMenuSpawnButton: respawnMenu_RscButton
        {
            ...
            h = 0.044 * safezoneH;
            action="['respawnMenuRespawnAction'] spawn wmi_respawn_fnc_handleRespawnUI";
        };
        ...
        class respawnMenuVOIP: respawnMenu_RscButton
        {
            ...
            action = "['toggleSpectator'] spawn wmi_respawn_fnc_handleRespawnUI";
        };
...
class respawnMenuMapDialog {
    ...
    class controls { 
        class FullRespawnMap : RscMapControl
        {
            ...
            w = 1 * safezoneW;
            h = 1 * safezoneH;
            onDraw = "_this call wmi_respawn_fnc_respawnDrawMapIcons";
            onSetFocus = "['respawnMapLoaded'] spawn wmi_respawn_fnc_handleRespawnUI";
            onMouseButtonDown = "['respawnMap_onMouseButtonDown',_this] spawn wmi_respawn_fnc_handleRespawnUI";
            onKeyUp = "['respawnMap_keyUp',_this] spawn wmi_respawn_fnc_handleRespawnUI";
        };
    };
};