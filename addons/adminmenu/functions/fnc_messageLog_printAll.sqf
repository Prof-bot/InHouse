...
/* ----------------------------------------------------------------------------
Internal Function: WMI_adminmenu_fnc_messageLog_printAll
...
Examples:
    (begin example)
        [] call WMI_adminmenu_fnc_messageLog_printAll;
    (end)
...
diag_log "[WMI Adminmenu] Printing complete log to RPT";
...
diag_log "[WMI Adminmenu] Log end";
