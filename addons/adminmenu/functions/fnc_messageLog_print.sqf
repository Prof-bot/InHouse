...
/* ----------------------------------------------------------------------------
Internal Function: WMI_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call WMI_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_WMI_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[WMI Adminmenu] Printed entry: %1%2",
