class Controls
{
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_SPECTATORTEXT;
        ...
        x = 0;
        y = 0;
        w = WMI_ADMINMENU_RESP_W_COL1;
        h = WMI_ADMINMENU_STD_HEIGHT;
    };
    class spectatorListBox: RscListBox
    {
        idc = IDC_WMI_ADMINMENU_RESP_SPECTATORLIST;
        
        sizeEx = WMI_ADMINMENU_STD_SIZEX;
        sizeEx2 = WMI_ADMINMENU_STD_SIZEX;
        //rowHeight = 0.97 * WMI_ADMINMENU_STD_HEIGHT;
        //rowHeight = WMI_ADMINMENU_STD_HEIGHT;
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_ADDBUTTON;
        text = "Add";
        x = WMI_ADMINMENU_RESP_X_COL2;
        y = "1.1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = WMI_ADMINMENU_RESP_W_COL2;
        h = WMI_ADMINMENU_STD_HEIGHT;
        onButtonClick=QUOTE((ctrlParent (param [0])) call FUNC(respawn_addAction));
    };
    class respawnMenuRemoveButton: GVAR(RscButtonMenu)
    {
        idc = IDC_WMI_ADMINMENU_RESP_REMOVEBUTTON;
        text = "Remove";
        x = WMI_ADMINMENU_RESP_X_COL2;
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_ROLECOMBO;
        text = "Role";
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_RANK;
        ...
        w = WMI_ADMINMENU_RESP_W_COL2;
        h = 2*WMI_ADMINMENU_STD_HEIGHT;
    };

    class respawnMenuVOIP: GVAR(RscButtonMenu)
    {
        idc = IDC_WMI_ADMINMENU_RESP_SPECTATORVOIP;
        text = "Toggle Spectator VOIP";
        x = WMI_ADMINMENU_RESP_X_COL3;
        y = "0";
        w = WMI_ADMINMENU_RESP_W_COL3;
        h = WMI_ADMINMENU_STD_HEIGHT;
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_GROUPLIST;
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_GROUPNAME;
        ...
        x = WMI_ADMINMENU_RESP_X_COL4;
        y = "2.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = WMI_ADMINMENU_RESP_W_COL4;
        h = WMI_ADMINMENU_STD_HEIGHT;
    };
    class respawnMenuFactionCategoryCombo: RscCombo
    {
        idc = IDC_WMI_ADMINMENU_RESP_FACTIONCATEGORY;
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_FACTION;
        text = "Faction";
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_SIDE;
        text = "Side";
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_GROUPMARKERCHECKBOX;
        text = "Give group marker";
        x = WMI_ADMINMENU_RESP_X_COL4 + (7 * (((safezoneW / safezoneH) min 1.2) / 40));
        y = "7.7 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = (1 * (((safezoneW / safezoneH) min 1.2) / 40));
        h = WMI_ADMINMENU_STD_HEIGHT;
        //action = "['respawnMenuToggleGroupCheckbox'] spawn WMI_respawn_fnc_handleRespawnUI";
    };
    class respawnMenuMarkerName: RscEdit
    {
        idc = IDC_WMI_ADMINMENU_RESP_GROUPMARKERNAME;
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_MARKERTYPE;
        text = "Side";
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_MARKERCOLOUR;
        text = "Side";
    ...
    {
        idc = IDC_WMI_ADMINMENU_RESP_SPAWNBUTTON;
        text = "Spawn Group";
        x = WMI_ADMINMENU_RESP_X_COL4;
    ...
    // {
        ...
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRoleAction'] spawn WMI_respawn_fnc_handleRespawnUI";
    // };
    ...
    // {
        ...
        // w = 0.0567187 * safezoneW;
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRankAction'] spawn WMI_respawn_fnc_handleRespawnUI";
    // };
};
