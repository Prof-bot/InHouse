class Controls
{
    class BackgroundMessagesList: RscText
    {
        x = 0;
        y = 0;
        w = WMI_ADMINMENU_MSGS_W_LIST;
        h = WMI_ADMINMENU_MSGS_H_LIST;
    ...
    {
        idc = IDC_WMI_ADMINMENU_MSGS_LIST;
    ...
    {
        idc = IDC_WMI_ADMINMENU_MSGS_COPY;
        ...
        x = 0 * WMI_ADMINMENU_STD_WIDTH;
        y = 19.5 * WMI_ADMINMENU_STD_HEIGHT;
        w = 9 * WMI_ADMINMENU_STD_WIDTH;
    };

    class ButtonPrintAll: GVAR(RscButtonMenu)
    {
        idc = IDC_WMI_ADMINMENU_MSGS_COPYALL;
        text = "PRINT ALL TO RPT";
        tooltip = "Prints all logged entries to RPT.";
        onButtonClick = QUOTE(_this call FUNC(messageLog_printAll));
        colorBackground[] = {0, 0, 0, 1};
        x = 9.1 * WMI_ADMINMENU_STD_WIDTH;
        y = 19.5 * WMI_ADMINMENU_STD_HEIGHT;
        w = 7 * WMI_ADMINMENU_STD_WIDTH;
    };
};
