class GVAR(modal)
{
    ...
    class Controls
    {
        ...
        {
            idc = IDC_WMI_ADMINMENU_MODAL_BACK;
        ...
        {
            idc = IDC_WMI_ADMINMENU_MODAL_TBACK;
        ...
        {
            idc = IDC_WMI_ADMINMENU_MODAL_TITLE;
            text = "WMI Admin Menu";
            style = 0;
            colorBackground[] = {0, 0, 0, 0};
            x = "1.5 * (((safezoneW / safezoneH) min 1.2) / 40) + (safezoneX + (safezoneW - ((safezoneW / safezoneH) min 1.2))/2)";
        ...
        {
            idc = IDC_WMI_ADMINMENU_MODAL_GBACK;
        ...
        class Close
        {
            idc = IDC_WMI_ADMINMENU_MODAL_CLOSE;
            type = 1;
            style = 48 + 2048;
