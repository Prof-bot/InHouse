...
GVAR(interfaceControls) = [
        IDC_SPECTATOR_WMI_SPECTATOR_KILLIST, IDC_SPECTATOR_WMI_SPECTATOR_UNITLABEL,
        IDC_SPECTATOR_WMI_SPECTATOR_UNITLIST, IDC_SPECTATOR_WMI_SPECTATOR_VISION,
        IDC_SPECTATOR_WMI_SPECTATOR_FILTER, IDC_SPECTATOR_WMI_SPECTATOR_BUTTON,
        IDC_SPECTATOR_WMI_SPECTATOR_TAGS, IDC_SPECTATOR_WMI_SPECTATOR_VIEW,
        IDC_SPECTATOR_WMI_SPECTATOR_COMPASS, IDC_SPECTATOR_WMI_SPECTATOR_COMPASSLEFT,
        IDC_SPECTATOR_WMI_SPECTATOR_COMPASSRight, IDC_SPECTATOR_WMI_SPECTATOR_MUTE,
        IDC_SPECTATOR_WMI_SPECTATOR_RADIO, IDC_SPECTATOR_WMI_SPECTATOR_MENUBACK
];
...
if !([] call wmi_common_fnc_isAdmin) then {
