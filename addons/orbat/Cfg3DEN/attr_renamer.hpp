class WMI_ORBAT_Renamer : Title
{
    onLoad = "uiNamespace setVariable ['WMI_OrbatRenamer_ctrlGroup', (_this select 0)];";
    attributeLoad = "";
    attributeSave = "true";
    h = 5 * SIZE_M * GRID_H;
    class Controls : Controls
    {
        ...
        class orbatRenamerButton : RscButtonMenu
        {
            ...
            y = 3.5 * SIZE_M * GRID_H;
            action = "[] call (missionNamespace getVariable 'wmi_orbat_fnc_renameUnitAndGroups');";
