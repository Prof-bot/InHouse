class ORBATSettings : Toolbox
{
    ...
    scriptPath = "WMI_orbat";
    onLoad = "['onLoad',_this,'ORBATSettings','WMI_orbat',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
    onUnload = "['onUnload',_this,'ORBATSettings','WMI_orbat',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
    ...
    class Controls
    {
        ...
        class TreeTop : RscButtonMenu
        {
            ...
            animTextureNormal = "\x\wmi\addons\orbat\ui\arrow_top_ca.paa";
            animTextureDisabled =  "\x\wmi\addons\orbat\ui\arrow_top_ca.paa";
            animTextureOver =  "\x\wmi\addons\orbat\ui\arrow_top_ca.paa";
            animTextureFocused =  "\x\wmi\addons\orbat\ui\arrow_top_ca.paa";
            animTexturePressed =  "\x\wmi\addons\orbat\ui\arrow_top_ca.paa";
            animTextureDefault =  "\x\wmi\addons\orbat\ui\arrow_top_ca.paa";
        ...
        {
            animTextureNormal = "\x\wmi\addons\orbat\ui\arrow_bottom_ca.paa";
            animTextureDisabled =  "\x\wmi\addons\orbat\ui\arrow_bottom_ca.paa";
            animTextureOver =  "\x\wmi\addons\orbat\ui\arrow_bottom_ca.paa";
            animTextureFocused =  "\x\wmi\addons\orbat\ui\arrow_bottom_ca.paa";
            animTexturePressed =  "\x\wmi\addons\orbat\ui\arrow_bottom_ca.paa";
            animTextureDefault =  "\x\wmi\addons\orbat\ui\arrow_bottom_ca.paa";
        ...
        class ColourValue: ctrlToolbox
        {
            ...
            strings[] = {
                ...
                "x\wmi\addons\orbat\textures\blue_blank.paa",
                "x\wmi\addons\orbat\textures\green_blank.paa",
                "x\wmi\addons\orbat\textures\red_blank.paa",
                "x\wmi\addons\orbat\textures\orange_blank.paa",
                "x\wmi\addons\orbat\textures\gray_blank.paa",
                "x\wmi\addons\orbat\textures\purple_blank.paa"
            };
            tooltips[] = {
                "Yellow",
                "Blue",
        ...
        class sizeValue: ctrlToolbox
        {
            ...
            columns = 6;
            strings[] = {
                "x\wmi\addons\orbat\textures\empty.paa",
                "x\wmi\addons\orbat\textures\modif_o.paa",
                "x\wmi\addons\orbat\textures\modif_dot.paa",
                "x\wmi\addons\orbat\textures\modif_2dot.paa",
                "x\wmi\addons\orbat\textures\modif_3dot.paa",
                "x\wmi\addons\orbat\textures\modif_company.paa"
            };
            tooltips[] = {"None",
