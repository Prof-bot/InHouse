class twGroupMarker: Toolbox
{
    ...
    onLoad = "['onLoad',_this,'GroupMarker','WMI_orbat',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
    onUnload = "['onUnload',_this,'GroupMarker','WMI_orbat',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
