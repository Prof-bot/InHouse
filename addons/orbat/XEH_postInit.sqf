...
GVAR(directionalFTMarkers) = getMissionConfigValue ["WMI_ORBATMarkersFT_Directional",false];
...
GVAR(orbatTrackerCodeCondition) = getMissionConfigValue ["WMI_ORBATTrackerCondition","true"];
...
GVAR(ftMarkersEnabled) = getMissionConfigValue ['WMI_ORBATMarkersFT', false];
FUNC(PFHUpdate) = {
