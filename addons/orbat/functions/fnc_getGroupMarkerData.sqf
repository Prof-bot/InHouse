...
private _cachedData = _group getVariable ["WMI_groupMarker_Cached",-1];
if (_cachedData isEqualTo -1) exitWith {
    private _data = _group getVariable ["WMI_groupMarker",[]];
    ...
    _group setVariable ["WMI_groupMarker_Cached", _data];
    _data;
};
