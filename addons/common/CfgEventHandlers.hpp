...
class Extended_DisplayLoad_EventHandlers {
    class RscDisplayMultiplayerSetup {
        wmi_slotting = QUOTE(_this call (uiNamespace getVariable 'FUNC(initDisplayMultiplayerSetup)'));
    };
    class RscDisplayDebriefing {
        wmi_override_end_text = QUOTE(_this call (uiNamespace getVariable 'FUNC(initDisplayDebriefing)'));
    };
};
