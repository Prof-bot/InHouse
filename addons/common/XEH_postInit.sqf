...
/// Some code relies on wmi_common__VarSync being set before processing e.g. briefing/radio assignment
// Register event to recieve notification of variable synchorization has been completed.
[QGVAR(serverVariableSyncResponse),{
    GVAR(VarSync) = true;
    diag_log "WMI Common: Variable Synchronization Completed";
