...
if (!(_mortarVeh isKindOf "wmi_2inch_vehicle")) exitWith {};

[{
	_display = uiNamespace getVariable ["wmi_2inch_RscWeaponRangeArtillery", displayNull];
	_precalcArray = [] call wmi_2inch_fnc_rangetable;
	{
