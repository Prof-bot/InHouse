...
{
    WMI_briefing = "x\wmi\addons\briefing\ui_scripts\"; //" - Escape for VS code linter
};
...
class Cfg3DEN
{
    class Mission
    {
        class WMI_MissionBriefingAttributes // Custom section class, everything inside will be opened in one window (MySection)
        {
            displayName = "WMI Briefing settings"; // Text visible in the window title as "Edit <displayName>"
            ...
            {
                class WMI_BriefingSettings
                {
                    displayName = "WMI: Briefing settings"; // Category name visible in Edit Attributes window
                    collapsed = 0; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class WMI_Briefing_Loadout
                        {
                            property = "WMI_Briefing_Loadout";
                            ...
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['WMI_Briefing_Loadout',_value];";
                            defaultValue = "false";
                            condition = "1";
                        };
                        class WMI_Briefing
                        {
                            property = "WMI_Briefing";
                            displayName = "";
                            control = "BriefingSettings";
                            //expression = "missionNamespace setVariable ['WMI_BriefingArray',_value];";
    ...
    class Group
    {
        ...
        class AttributeCategories
        {
            ...
            class WMIMarker
            {
                class Attributes
                {
                    class WMI_Briefinglist
                    {
                        displayName = ""; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "WMI_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression =  "[_this,'WMI_Briefinglist',_value] call wmi_common_fnc_initGroupVar;";// "_this setVariable ['WMI_Briefinglist',_value],true;";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                };
            ...
            class WMIMarker
            {
                class Attributes
                {
                    class WMI_Briefinglist
                    {
                        ...
                        property = "WMI_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['WMI_Briefinglist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
    ...
    class Attributes
    {
        ...
        class BriefingSettings : Toolbox
        {
            ...
            scriptPath = "WMI_briefing";
            onLoad = "['onLoad',_this,'BriefingSettings','WMI_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'BriefingSettings','WMI_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
